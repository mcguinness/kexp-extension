define(["collections/LastFmCollection"], function(LastFmCollection) {
  ...
  describe("LastFmCollection", function() {
    ...
    describe("#add", function() {
      ...
      it("should add 2 new models to collection", function() {
        var collection = new LastFmCollection();
        collection.add(ARTIST_RESPONSE, {parse: true});
        collection.add(ALBUM_RESPONSE, {parse: true});
    ...
    describe("#getOrFetchArtist", function() {
      ...
      it("should call error callback when called with invalid artist", function(done) {
        ...
        this.collection.getOrFetchArtist("Janky Mouse")
          .then(this.successCallback, this.errorCallback)
          .always(function() {
            self.successCallback.should.not.be.called;
            self.errorCallback.should.be.calledWith(self.errorCallback.args[0][0], ARTIST_NOT_FOUND_ERROR);
            done();
          });
      });
    });
    ...
    describe("#getOrFetchAlbum", function() {
      ...
      it("should call success callback with existing model and not call fetch when called with valid artist & album", function(done) {

        var self = this;
        this.collection.add(ALBUM_RESPONSE, {parse: true});
        this.collection.getOrFetchAlbum("Modest Mouse", "The Lonesome Crowded West")
          .then(this.successCallback, this.errorCallback)
          .always(function() {
            var model = self.successCallback.args[0][0];
            model.isAlbum().should.be.true;
            model.get("name").should.equal("The Lonesome Crowded West");
            self.syncStub.should.not.be.called;
            done();
          });
      });
      ...
      it("should call success callback and retrieve model by fetch and when called with valid artist & album", function(done) {
      ...
      it("should call error callback when called with invalid artist", function(done) {
        ...
        this.collection.getOrFetchAlbum("Janky Mouse", "The Lonesome Crowded West")
          .then(this.successCallback, this.errorCallback)
          .always(function() {
            self.successCallback.should.not.be.called;
            self.errorCallback.should.be.calledWith(self.errorCallback.args[0][0], ARTIST_NOT_FOUND_ERROR);
      ...
      it("should call error callback when called with invalid album", function(done) {
        ...
        this.collection.getOrFetchAlbum("Modest Mouse", "The Lonesome Crowded East")
          .then(this.successCallback, this.errorCallback)
          .always(function() {
            self.successCallback.should.not.be.called;
            self.errorCallback.should.be.calledWith(self.errorCallback.args[0][0], ALBUM_NOT_FOUND_ERROR);
            done();
          });
      });
    });
